...
INSERT INTO `localizacion` VALUES (1,4,19,21.5,-72,2,30.1,215,'alto manacacias',738),(2,4,4,20.5,-73,34,53.32,200,'cocuy-unillanos',748),(3,4,8,15.8,-73,40,31.63,200,'vereda el carmen',748),(4,6,11,14.2,-75,38,27.321,215,'vereda la verde',70),(5,10,14,12.07,-74,16,36.32,215,'corregimiento monterrubio',710);
...
INSERT INTO `usuarios` VALUES (1,'EstebanRamos','nikol','ADMINISTRADOR'),(2,'DanielMuñoz','kory267','ADMINISTRADOR'),(3,'SebastianLoaiza','sara','INVITADO'),(4,'Santiagolozada','natalie','INVITADO'),(5,'1','1','ADMINISTRADOR');
...
-- Dump completed on 2014-12-07 13:45:43

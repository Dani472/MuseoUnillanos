...
INSERT INTO `animal_colectado` VALUES (1,5,4,1,'Disponible','captura en red','2011-11-03','Veniliornis passerinus',22.75,'borde rastrojo bajo',NULL,NULL),(2,2,2,1,'Disponible','caza','2014-12-24','Struthio camelus syriacus 2',22,'llanura',NULL,'M');
...
INSERT INTO `colectores` VALUES (1,'A. Contreras',NULL),(2,'F. Aponte',NULL),(3,'J.E. Avendaño',NULL),(4,'J.J. Amaya',NULL),(5,'K.E. Mendez',NULL),(6,'R. Valencia',NULL);
...
INSERT INTO `especies` VALUES (1,'Aerodramus elaphrus',1),(2,'Fimbriata',4),(3,'lactea',4),(4,'Struthio camelus',7),(5,'passerinus',8);
...
INSERT INTO `familia` VALUES (1,'Apodidae',1),(2,'Hemiprocnidae',1),(3,'Trochilidae',1),(4,'Caprimulgidae',2),(5,'Steatornithidae',2),(6,'Struthionidae',3),(7,'Picidae',3);
...
INSERT INTO `genero` VALUES (1,'Aerodramus',1),(2,'Aeronautes',1),(3,'Nyctiprogne',1),(4,'Amazilia',3),(5,'Lurocalis',4),(6,'Nyctiphrynus',4),(7,'Struthio',6),(8,'Veniliornis',7);
...
INSERT INTO `localizacion` VALUES (1,4,19,21.5,72,2,30.1,215,'alto manacacias',738);
...
INSERT INTO `ornitologia` VALUES (1,1,NULL,276,NULL,NULL,'vacio','Corporal general moderado','Iris marrón, maxila gris oscuro, mandíbula gris claro borde de pico gris oscuro, tarsos dedos y uñas gris oscuro, suelas color carne','T.I 3,3 mm X 1,5 mm',100),(2,2,NULL,12,'oviparo',23,'huevos','Corporal general moderado','los pies','2',12),(2,3,NULL,12,'oviparo',23,'huevos','Corporal general moderado','los brazos','2',12);
...
INSERT INTO `subespecie` VALUES (1,'Struthio camelus camelus',4),(2,'Struthio camelus syriacus',4),(3,'Struthio camelus massaicus',4),(4,'null',5);
...
INSERT INTO `tejidos` VALUES (1,2,'corazon ','tejido','es el corazon de un animal no joda '),(2,2,'Adn','adn','parte de adn del ombligo');
...
INSERT INTO `usuarios` VALUES (1,'EstebanRamos','smelltofish','ADMINISTRADOR'),(2,'DanielMuñoz','kory267','ADMINISTRADOR'),(3,'SebastianLoaiza','sarav','INVITADO'),(4,'2','2','INVITADO'),(5,'1','1','ADMINISTRADOR');
...
-- Dump completed on 2014-12-06 12:24:59
